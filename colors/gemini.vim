...
call s:hi('CursorLineNr', s:p.fg, s:p.bg, 'bold', '')
call s:hi('LineNr', s:p.comment, s:p.bg, '', '')
call s:hi('SignColumn', '', s:p.bg, '', '')
call s:hi('FoldColumn', s:p.comment, s:p.bg, '', '')
call s:hi('CursorLineSign', '', s:p.bg, '', '')
call s:hi('CursorLineFold', s:p.comment, s:p.bg, '', '')
...
call s:hi('SignifySignAdd', s:p.green, s:p.bg, '', '')
call s:hi('SignifySignChange', s:p.orange, s:p.bg, '', '')
call s:hi('SignifySignDelete', s:p.red, s:p.bg, '', '')
call s:hi('SignifySignChangeDelete', s:p.red, s:p.bg, '', '')
call s:hi('SignifySignDeleteFirstLine', s:p.red, s:p.bg, '', '')
call s:hi('SignifySignAddNr', s:p.green, s:p.bg, '', '')
call s:hi('SignifySignChangeNr', s:p.orange, s:p.bg, '', '')
call s:hi('SignifySignDeleteNr', s:p.red, s:p.bg, '', '')
call s:hi('SignifySignChangeDeleteNr', s:p.red, s:p.bg, '', '')
call s:hi('SignifySignDeleteFirstLineNr', s:p.red, s:p.bg, '', '')
call s:hi('SignifyLineAdd', '', '#0B1A10', '', '')
call s:hi('SignifyLineChange', '', '#1E1606', '', '')
call s:hi('SignifyLineDelete', '', '#200B0B', '', '')

call s:hi('GitGutterAdd', s:p.green, s:p.bg, '', '')
call s:hi('GitGutterChange', s:p.orange, s:p.bg, '', '')
call s:hi('GitGutterDelete', s:p.red, s:p.bg, '', '')
call s:hi('GitGutterChangeDelete', s:p.red, s:p.bg, '', '')
call s:hi('GitGutterAddLineNr', s:p.green, '', '', '')
call s:hi('GitGutterChangeLineNr', s:p.orange, '', '', '')
call s:hi('GitGutterDeleteLineNr', s:p.red, '', '', '')

call s:hi('GitSignsAdd', s:p.green, s:p.bg, '', '')
call s:hi('GitSignsChange', s:p.orange, s:p.bg, '', '')
call s:hi('GitSignsDelete', s:p.red, s:p.bg, '', '')
call s:hi('GitSignsAddNr', s:p.green, '', '', '')
call s:hi('GitSignsChangeNr', s:p.orange, '', '', '')
call s:hi('GitSignsDeleteNr', s:p.red, '', '', '')
call s:hi('GitSignsAddLn', '', '#0B1A10', '', '')
call s:hi('GitSignsChangeLn', '', '#1E1606', '', '')
call s:hi('GitSignsDeleteLn', '', '#200B0B', '', '')

call s:hi('GitSignifyDiff', s:p.fg, s:p.bg, '', '')
